...
export default function DocsPage() {
  ...
  return (
    <Container className="py-8">
      ...
      <p className="text-[11px] sm:text-sm text-gray-500 mb-8">
        ...
        <div className="flex-1 min-w-0 space-y-12">
          ...
          <section id="intro" className="scroll-mt-20">
            ...
            <div className="prose prose-sm max-w-none bg-white rounded-xl border border-gray-200 p-6">
              ...
              <h3 className="text-[15px] sm:text-base font-semibold text-gray-800 mb-2">核心功能</h3>
              <ul className="text-[11px] sm:text-sm text-gray-600 space-y-1.5 ml-4 list-disc">
          ...
          <section id="quick-start" className="scroll-mt-20">
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-6 space-y-4">
              <div>
                <h3 className="text-[15px] sm:text-base font-semibold text-gray-800 mb-2">1. 注册账号</h3>
              ...
              <div>
                <h3 className="text-[15px] sm:text-base font-semibold text-gray-800 mb-2">2. 完善资料</h3>
                <p className="text-[11px] sm:text-sm text-gray-600">
              ...
              <div>
                <h3 className="text-[15px] sm:text-base font-semibold text-gray-800 mb-2">3. 参与社区</h3>
                <p className="text-[11px] sm:text-sm text-gray-600">
              ...
              <div>
                <h3 className="text-[15px] sm:text-base font-semibold text-gray-800 mb-2">4. 搜索内容</h3>
                <p className="text-[11px] sm:text-sm text-gray-600">
                  使用顶部搜索框可快速搜索帖子标题和内容，
                  移动端点击底部导航栏的搜索图标即可使用。
                </p>
          ...
          <section id="community" className="scroll-mt-20">
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-6 space-y-4">
              <div>
                <h3 className="text-[15px] sm:text-base font-semibold text-gray-800 mb-2">发帖</h3>
                <p className="text-[11px] sm:text-sm text-gray-600">
              ...
              <div>
                <h3 className="text-[15px] sm:text-base font-semibold text-gray-800 mb-2">评论与回复</h3>
                <p className="text-[11px] sm:text-sm text-gray-600">
              ...
              <div>
                <h3 className="text-[15px] sm:text-base font-semibold text-gray-800 mb-2">点赞与收藏</h3>
                <p className="text-[11px] sm:text-sm text-gray-600">
              ...
              <div>
                <h3 className="text-[15px] sm:text-base font-semibold text-gray-800 mb-2">分类与排序</h3>
                <p className="text-[11px] sm:text-sm text-gray-600">
              ...
              <div>
                <h3 className="text-[15px] sm:text-base font-semibold text-gray-800 mb-2">帖子编辑与删除</h3>
                <p className="text-[11px] sm:text-sm text-gray-600">
                  帖子作者可编辑和删除自己的帖子（软删除）。
                  管理员可执行置顶、加精、锁定等管理操作。
                </p>
          ...
          <section id="profile" className="scroll-mt-20">
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-6 space-y-4">
              <div>
                <h3 className="text-[15px] sm:text-base font-semibold text-gray-800 mb-2">资料管理</h3>
                <p className="text-[11px] sm:text-sm text-gray-600">
              ...
              <div>
                <h3 className="text-[15px] sm:text-base font-semibold text-gray-800 mb-2">我的帖子</h3>
                <p className="text-[11px] sm:text-sm text-gray-600">
                  查看自己发布的所有帖子，支持分页浏览，可快速编辑或查看。
                </p>
              </div>
              <div>
                <h3 className="text-[15px] sm:text-base font-semibold text-gray-800 mb-2">我的评论</h3>
                <p className="text-[11px] sm:text-sm text-gray-600">
                  查看自己在各帖子下发表的所有评论，可快速跳转到原帖。
                </p>
              </div>
              <div>
                <h3 className="text-[15px] sm:text-base font-semibold text-gray-800 mb-2">我的点赞</h3>
                <p className="text-[11px] sm:text-sm text-gray-600">
                  查看所有点赞过的帖子列表，支持分页浏览。
                </p>
              </div>
              <div>
                <h3 className="text-[15px] sm:text-base font-semibold text-gray-800 mb-2">等级系统</h3>
                <p className="text-[11px] sm:text-sm text-gray-600">
          ...
          <section id="dark-mode" className="scroll-mt-20">
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-6">
              <p className="text-[11px] sm:text-sm text-gray-600 leading-relaxed mb-3">
          ...
          <section id="mobile" className="scroll-mt-20">
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-6">
              ...
              <h3 className="text-[15px] sm:text-base font-semibold text-gray-800 mb-2">底部导航栏</h3>
              <p className="text-[11px] sm:text-sm text-gray-600 leading-relaxed mb-3">
                移动端底部提供四个快捷入口：首页、社区、搜索、我的。
                可快速在不同功能区之间切换。
              </p>
              <h3 className="text-[15px] sm:text-base font-semibold text-gray-800 mb-2">搜索功能</h3>
              <p className="text-[11px] sm:text-sm text-gray-600 leading-relaxed">
          ...
          <section id="github-code" className="scroll-mt-20">
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-6 space-y-4">
              ...
              <div>
                <h3 className="text-[15px] sm:text-base font-semibold text-gray-800 mb-2">方式一：搜索引用（推荐）</h3>
              ...
              <div>
                <h3 className="text-[15px] sm:text-base font-semibold text-gray-800 mb-2">方式二：粘贴链接自动识别</h3>
                <p className="text-[11px] sm:text-sm text-gray-600 mb-2">
                  在编辑器中直接粘贴代码仓库文件链接，系统会自动识别并转换为代码块：
                </p>
                <div className="bg-gray-900 rounded-lg p-4 text-[11px] sm:text-sm text-gray-300 font-mono overflow-x-auto">
              ...
              <div>
                <h3 className="text-[15px] sm:text-base font-semibold text-gray-800 mb-2">方式三：短代码</h3>
                <p className="text-[11px] sm:text-sm text-gray-600 mb-2">
              ...
              <div>
                <h3 className="text-[15px] sm:text-base font-semibold text-gray-800 mb-2">方式四：手动嵌入</h3>
                <p className="text-[11px] sm:text-sm text-gray-600 mb-2">
              ...
              <div>
                <h3 className="text-[15px] sm:text-base font-semibold text-gray-800 mb-2">可选参数</h3>
                <p className="text-[11px] sm:text-sm text-gray-600 mb-2">
                  在路径后添加查询参数：
                </p>
                <ul className="text-[11px] sm:text-sm text-gray-600 space-y-1.5 ml-4 list-disc">
                ...
                <div className="mt-3 bg-gray-900 rounded-lg p-4 text-[11px] sm:text-sm text-gray-300 font-mono overflow-x-auto">
                  <div>{'```github-code'}</div>
              ...
              <div>
                <h3 className="text-[15px] sm:text-base font-semibold text-gray-800 mb-2">支持的文件类型</h3>
                <p className="text-[11px] sm:text-sm text-gray-600">
          ...
          <section id="collab" className="scroll-mt-20">
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-6 space-y-4">
              ...
              <div>
                <h3 className="text-[15px] sm:text-base font-semibold text-gray-800 mb-2">发起召集令</h3>
                <p className="text-[11px] sm:text-sm text-gray-600 mb-2">
              ...
              <div>
                <h3 className="text-[15px] sm:text-base font-semibold text-gray-800 mb-2">任务管理</h3>
                <p className="text-[11px] sm:text-sm text-gray-600">
              ...
              <div>
                <h3 className="text-[15px] sm:text-base font-semibold text-gray-800 mb-2">提交贡献与审核</h3>
                <p className="text-[11px] sm:text-sm text-gray-600">
              ...
              <div>
                <h3 className="text-[15px] sm:text-base font-semibold text-gray-800 mb-2">协作规范</h3>
                <ul className="text-[11px] sm:text-sm text-gray-600 space-y-1.5 ml-4 list-disc">
              ...
              <div>
                <h3 className="text-[15px] sm:text-base font-semibold text-gray-800 mb-2">角色权限</h3>
              ...
              <div className="flex flex-wrap gap-3 pt-2">
                <Link
                  href="/collab"
                  className="inline-flex items-center gap-2 px-4 py-2 text-[13px] sm:text-sm font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700 transition-colors"
                >
                  🐙 浏览召集令
                </Link>
                <Link
                  href="/collab/new"
                  className="inline-flex items-center gap-2 px-4 py-2 text-[13px] sm:text-sm font-medium text-blue-600 bg-blue-50 rounded-lg hover:bg-blue-100 transition-colors"
                >
                  🚀 发起召集令
                </Link>
                <Link
                  href="/collab/guide"
                  className="inline-flex items-center gap-2 px-4 py-2 text-[13px] sm:text-sm font-medium text-gray-600 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors"
                >
                  📖 完整教程
                </Link>
              </div>
          ...
          <section id="faq" className="scroll-mt-20">
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-6 space-y-4">
              <div>
                <h3 className="text-[15px] sm:text-base font-semibold text-gray-800 mb-1">如何修改头像？</h3>
                <p className="text-[11px] sm:text-sm text-gray-600">
                  进入个人中心 → 编辑资料 → 头像区域，可输入图片 URL 或选择 Emoji 作为头像。
                </p>
              </div>
              <div>
                <h3 className="text-[15px] sm:text-base font-semibold text-gray-800 mb-1">帖子支持什么格式？</h3>
                <p className="text-[11px] sm:text-sm text-gray-600">
                  帖子内容支持 Markdown 格式，包括标题、列表、代码块、链接、图片等。
                </p>
              </div>
              <div>
                <h3 className="text-[15px] sm:text-base font-semibold text-gray-800 mb-1">评论为什么没有立即显示？</h3>
                <p className="text-[11px] sm:text-sm text-gray-600">
              ...
              <div>
                <h3 className="text-[15px] sm:text-base font-semibold text-gray-800 mb-1">忘记密码怎么办？</h3>
                <p className="text-[11px] sm:text-sm text-gray-600">
              ...
              <div>
                <h3 className="text-[15px] sm:text-base font-semibold text-gray-800 mb-1">用量监控数据是实时的吗？</h3>
                <p className="text-[11px] sm:text-sm text-gray-600">
              ...
              <div>
                <h3 className="text-[15px] sm:text-base font-semibold text-gray-800 mb-1">如何在帖子中嵌入代码仓库文件？</h3>
                <p className="text-[11px] sm:text-sm text-gray-600">
