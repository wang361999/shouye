...
export default function ToolDetailPage({
  ...
  useEffect(() => {
    const checkMobile = () => {
      ...
      setIsMobile(mobile);
      // 移动端内嵌工具自动全屏
      if (mobile && tool?.toolType === "embedded" && tool?.htmlContent) {
        setFullscreen(true);
      }
    };
    checkMobile();
            ...
            <>
              ...
              {fullscreen ? (
                <div className="fixed inset-0 z-50 bg-white">
                  ...
                  <div className="flex items-center justify-between px-3 py-2 bg-gray-900 text-white">
                    ...
                    <button
                      ...
                      className="flex items-center gap-1 px-3 py-1 text-xs font-medium bg-white/10 rounded-lg hover:bg-white/20 transition-colors"
                    >
                  ...
                  {/* 加载骨架 */}
                  {!iframeLoaded && (
                    <div className="flex items-center justify-center bg-gray-50" style={{ height: "calc(100vh - 40px)" }}>
                      <div className="flex flex-col items-center gap-3">
                        <div className="w-10 h-10 border-3 border-blue-200 border-t-blue-600 rounded-full animate-spin" />
                        <span className="text-xs text-gray-400">工具加载中...</span>
                      </div>
                    </div>
                  )}
                  <iframe
                ...
                <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
                  ...
                  {/* 加载骨架 */}
                  {!iframeLoaded && (
                    <div className="flex items-center justify-center bg-gray-50" style={{ minHeight: "400px" }}>
                      <div className="flex flex-col items-center gap-3">
                        <div className="w-10 h-10 border-3 border-blue-200 border-t-blue-600 rounded-full animate-spin" />
                        <span className="text-xs text-gray-400">工具加载中...</span>
                      </div>
